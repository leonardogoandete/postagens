...
public class PostagemResourceTest {
    ...
    PostagemResource postagemResource = new PostagemResource(postagemService, postagemMapper);
    ...
    public void testListarPostagens() {
        given()
                ...
                .body("$", hasSize(greaterThan(0))); // Verifica se há pelo menos uma postagem retornada
    }
...
//        List<Postagem> postagemList = postagemMapper.toListPostagemDadosListagens(postagens);
//        Mockito.when(postagemService.listarTodasPostagens()).thenReturn(postagemList);
//
